...
--
-- Name: properties ciao; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT ciao FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
